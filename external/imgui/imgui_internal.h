...
struct IMGUI_API ImGuiWindow
{
    ...
    // The main 'OuterRect', omitted as a field, is window->Rectangle().
    ImRect                  OuterRectClipped;                   // == Window->Rectangle() just after setup in Begin(). == window->Rectangle() for root window.
